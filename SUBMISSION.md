...
On a live run (2026-08-28): 13,733 VIIRS detections across South America in 24h, 394 inside the demo AOI, clustered into 10 events, cross-referenced against 4,216 OpenStreetMap road segments, end-to-end API response ~200ms. The top target is a 103-detection, 1,282 MW fire on unclassified land; rank 5 is a 2-detection fire scoring 55.4 because it falls inside the Xingu Indigenous Park — invisible on a heatmap, a named, justified target on the patrol queue. We independently corroborated vegetation loss in the AOI via Sentinel-2 NDVI (0.4750 → 0.4082, a decline of 0.0669, comparing 2025-09-29 to 2026-08-27 scenes).
